...
public class ProjectTaskDTO {
	...
	public ProjectTaskDTO(Integer id, String projectSequence, String summary, String acceptanceCriteria, String status,
			LocalDate dueDate, BacklogDTO backLog, Integer projectIdentifier, LocalDate createdAt, LocalDate updatedAt) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProjectTaskDTO other = (ProjectTaskDTO) obj;
